...
class Window {
	...
	**/
	...
	var canvasPos(get, never) : { var width(default, never) : Float; var height(default, never) : Float; var left(default, never) : Float; var top(default, never) : Float; };

	function get_canvasPos() {
		return js.Browser.supported ? canvas.getBoundingClientRect() : { "width":0, "top":0, "left":0, "height":0 };
	}
